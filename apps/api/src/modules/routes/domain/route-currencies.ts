...
export function getCurrencyForCountry(countryCode: string): string | null {
  ...
  return ROUTE_COUNTRY_CURRENCIES[countryCode];
}
...
export function isSupportedCurrency(value: string): boolean {
  return Object.values(ROUTE_COUNTRY_CURRENCIES).includes(value);
}

export const SUPPORTED_CURRENCIES = [
  ...new Set(Object.values(ROUTE_COUNTRY_CURRENCIES)),
] as string[];

export { ROUTE_COUNTRY_CODES };
